...
async def updateUserGroup(user_group_id: int, user_group: list[schemas.UserGroup], db: Session = Depends(get_db)):
    return repository.create_user_Group(db, user_group, user_group_id)
